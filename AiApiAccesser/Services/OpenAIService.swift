        ...
        return URLSession.shared.dataTaskPublisher(for: request)
            ...
            .tryMap { data -> String in
                guard let json = try? JSONSerialization.jsonObject(with: data) as? [String: Any] else {
                    throw LLMServiceError.responseParsingError(NSError(domain: "OpenAI", code: 0, userInfo: [NSLocalizedDescriptionKey: "Failed to parse JSON"]))
                }
                ...
                guard let choices = json["choices"] as? [[String: Any]],
                    ...
                    throw LLMServiceError.responseParsingError(NSError(domain: "OpenAI", code: 0, userInfo: [NSLocalizedDescriptionKey: "Failed to extract message content"]))
                }
